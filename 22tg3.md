...
- Travail sur deux textes : Kant vs. les sagesses antiques `Vendredi 9 septembre : Jusqu'au travail sur le texte de Kant et le texte à propos des sagesses antiques <span>(idée directrice dégagée, argumentation à préciser pour chaque texte)</span>`
...
- Exemple principal : _Les Noces Rebelles_ + autres exemples `Lundi 12 septembre : Jusqu'au visionnage de l'extrait des <i>Noces Rebelles</i>`
